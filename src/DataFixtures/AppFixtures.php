...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $article1->setTitle("Les développeurs Web, « rock stars » du marché de l’emploi, craignent de devenir les « ouvriers d’hier »");
        $article1->setIntroduction("Toujours très convoités et choyés par les recruteurs, les développeurs Web considèrent que leur position avantageuse est arrivée à un point d’équilibre. Certains craignent de se laisser dépasser par l’intelligence artificielle et les évolutions technologiques.");
        $article1->setImage("daveledev.jpeg");
